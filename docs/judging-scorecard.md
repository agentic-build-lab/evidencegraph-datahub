...
Current snapshot (August 7, 2026): four focused upstream pull requests are open and non-draft, and
their conventional-title checks pass. Relevant local checks pass; the upstream lint workflows await
maintainer approval for this first-time fork contributor. See
[`docs/OPEN_SOURCE_CONTRIBUTIONS.md`](OPEN_SOURCE_CONTRIBUTIONS.md).
