...
colors:
  ...
  text-muted: "#FF7048"
  text-light: "#656565"
  accent-light: "rgba(64, 224, 192, 0.08)"
  accent-medium: "rgba(64, 224, 192, 0.15)"
  border: "rgba(64, 224, 192, 0.2)"
  card-bg: "rgba(64, 224, 192, 0.04)"
  positive: "#059669"
  negative: "#dc2626"
...
typography:
  ...
  tag:     { fontFamily: "Geist", px: 12, weight: 600, color: "primary" }
  counter: { fontFamily: "Geist", px: 13, weight: 600, tracking: "0.05em", color: "text-muted" }
  # — display / numerical ramp (Geist, near-black headings / cobalt numerals) —
  h3:      { fontFamily: "Geist", cqw: 1.25, weight: 600, lineHeight: 1.3, tracking: "-0.02em", color: "text" }
  stat-num:{ fontFamily: "Geist", cqw: 1.9, weight: 700, lineHeight: 1.0, color: "primary" }
  blockquote:{ fontFamily: "Geist", cqw: 2.4, weight: 600, lineHeight: 1.35, color: "text" }
...
- **Weights** — the brand font ships `{400, 600, 650, 700, 720, 900}` only; every weight is clamped to these — ignore higher preset weights (e.g. 600/700) in prose.
